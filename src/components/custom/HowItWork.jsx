...
const steps = [
  {
    icon: <Briefcase className="w-12 h-12 text-yellow-400 drop-shadow-[0_0_8px_rgba(255,225,0,0.4)]" />,
  ...
  {
    icon: <MessageSquareText className="w-12 h-12 text-pink-400 drop-shadow-[0_0_8px_rgba(225,0,255,0.4)]" />,
  ...
  {
    icon: <Zap className="w-12 h-12 text-green-400 drop-shadow-[0_0_8px_rgba(0,255,100,0.4)]" />,
  ...
  <section className="min-h-screen bg-gradient-to-r from-[#0b0f14] via-[#0b0f14] to-[#0a0e14] text-white">
    <div className="max-w-4xl mx-auto px-2 text-center">
      ...
      <p className="text-gray-300 leading-relaxed max-w-2xl mx-auto mb-16 font-medium">
        Get ready for your next interview with our AI-powered platform. Follow these simple steps to practice, learn, and improve.
      </p>
      ...
      <div className="flex flex-col gap-16 relative z-10">
        {steps.map((step, idx) => (
          ...
          >
            {/* Step Card */}
            <div className="bg-[#151a23]/90 border border-blue-900 rounded-2xl px-8 py-10 shadow-xl shadow-blue-700/20 flex flex-col items-center text-center md:min-w-[320px] min-w-0 hover:scale-105 hover:shadow-blue-400/40 transition-all duration-300 relative">
