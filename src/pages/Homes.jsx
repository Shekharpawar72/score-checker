...
const Homes = () => {
  ...
  //   gsap.fromTo(
  //     appRef.current,
  //     { scale: 0.9, y: 30, opacity: 0 }, // start slightly smaller + lower
  //     {
  //       scale: 1, 
  //       y: 0, 
  //       opacity: 1,
  //       duration: 3.5, // ⏳ longer for smoother transition
  //       ease: "power4.inOut", // 🌀 very smooth easing
  //     }
  //   );
  // }
